    ...
    <header className="sticky top-0 z-50 h-16 flex items-center px-4 md:px-6 bg-gradient-to-r from-gray-900 via-gray-900/95 to-black/90 backdrop-blur-md border-b border-saffron-500/50 shadow-[0_4px_20px_-4px_rgba(255,153,51,0.15)] gap-2">
      ...
      <div className="flex items-center gap-4 sm:gap-6">
        ...
        <div className="flex items-center gap-3 md:gap-4">
          {/* Notification bell */}
          <button className="relative p-2 rounded-xl text-gray-400 hover:text-white hover:bg-white/10 transition-all border border-transparent hover:border-white/10">
            <Bell size={18} />
            <span className="absolute top-1.5 right-1.5 w-2 h-2 bg-saffron-500 rounded-full shadow-[0_0_6px_rgba(255,153,51,0.8)]" />
          </button>
