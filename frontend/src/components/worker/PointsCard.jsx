  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 p-6 flex flex-col md:flex-row md:items-center justify-between gap-6">
      <div className="flex items-center gap-5">
        <div className="w-14 h-14 rounded-full bg-orange-50 border border-orange-100 flex items-center justify-center flex-shrink-0">
        ...
        <div>
          ...
          <div className="flex items-baseline gap-2">
            ...
            <span className="text-orange-600 font-bold text-sm tracking-tight">PTS</span>
          </div>
        </div>
      </div>
